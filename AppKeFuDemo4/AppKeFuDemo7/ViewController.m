...
#define DEMO_WOKGROUP_ID  @"bjhlhqwg"
    ...
    else if (indexPath.row == 2)
    {
        ...
        [[AppKeFuLib sharedInstance] pushChatViewController:self.navigationController
         ...
         //下面5个参数专为显示商品信息设置，具体含义可以参考AppKeFuLib.h文件里面对接口的介绍
                                      ...
                                      withGoodsImageViewURL:@"http://im.95ykf.com/AppKeFu/images/logo.png"
                                       withGoodsTitleDetail:@"商品信息商品简介商品简介商品信息"
                                             withGoodsPrice:@"￥200000.00"
                                               withGoodsURL:@"http://im.95ykf.com"
        ...
        [[AppKeFuLib sharedInstance] pushChatViewController:self.navigationController
                                 ...
                                 withLeftBarButtonItemColor:[UIColor whiteColor]
                                   hidesBottomBarWhenPushed:FALSE
                                        ...
                                        withUserAvatarImage:[UIImage imageNamed:@"kefu_avatar"] //“user_avatar”
...
- (void)isConnected:(NSNotification*)notification
{
    ...
    if ([isConnected boolValue])
    {
        ...
        //
        //查询工作组在线状态，需要将wgdemo替换为开发者自己的 “工作组名称”，请在官方管理后台申请，地址：http://im.95ykf.com/AppKeFu/admin
